...
const Header = () => {
  ...
  return (
    <div className="bg-white border-b border-[#E5E7EB] text-black pt-3">
        ...
        <div className="flex gap-8 p-1 px-6">
          <div className="relative">
            <Link to={"/dashboard/Settings/notification"}>
              <div className="w-[45px] h-[45px] flex items-center justify-center text-xl rounded-lg bg-primary-light text-[#822CE7] ">
                <span>
                  <LuBell />
                </span>
              </div>
